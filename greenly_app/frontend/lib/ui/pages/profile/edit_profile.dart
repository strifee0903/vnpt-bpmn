...
//       imageQuality: 85, // Optional quality reduction
//     );
...
//               .format(_selectedDate!) // Changed to 'yyyy-MM-dd'
//           : '',
...
//     try {
//       await _userService.updateCurrentUser(fields, u_avtFile: avatarMultipart);
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
...
//       appBar: AppBar(
//         title: Text('Edit Profile', style: TextStyle(fontFamily: 'Oktah')),
//         backgroundColor: background,
//         elevation: 0,
//         leading: IconButton(
...
//               ? Center(
//                   child: Text(_error!,
//                       style: TextStyle(color: Colors.red, fontFamily: 'Oktah')))
//               : Padding(
...
//                                 _error!,
//                                 style: TextStyle(
//                                     color: Colors.red, fontFamily: 'Oktah'),
//                               ),
//                             ),
//                           ],
//                         ],
