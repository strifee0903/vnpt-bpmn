...
//       appBar: PreferredSize(
//         preferredSize:
//             const Size.fromHeight(70), // Reduced height to minimize gap
//         child: AppBar(
//           backgroundColor: Colors.white,
//           elevation: 0,
//           automaticallyImplyLeading: false,
...
//           ),
//           SliverToBoxAdapter(
//             child: SizedBox(height: 4), // Reduced spacer to minimize gap
//           ),
//           if (_error != null)
//             SliverToBoxAdapter(
//               child: Padding(
...
//   @override
//   double get maxExtent => 60; // Reduced to minimize gap
//   @override
//   double get minExtent => 60; // Reduced to minimize gap
