...
class _MyDiaryState extends State<MyDiary> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MomentProvider>(builder: (context, momentProvider, child) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 0,
          systemOverlayStyle:
              SystemUiOverlayStyle.dark, // Dark icons for status bar
        ),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
              RefreshIndicator(
                backgroundColor:
                    Colors.white, // Set refresh indicator background
                ...
                child: CustomScrollView(
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      child: Container(
                        color: Colors.white, // Set background here
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            final moment =
                                momentProvider.profileMoments[index - 1];
                            return Container(
                          ...
                          childCount: momentProvider.profileMoments.isEmpty
                              ? 2
                              : momentProvider.profileMoments.length + 1,
                        ),
                      ),
                  ],
                ),
